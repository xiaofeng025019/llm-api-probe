...
def upgrade() -> None:
    ...
    sa.Column('kind', sa.Enum('openai', 'openai_compat', 'anthropic', 'gemini', name='providerkind'), nullable=False),
    ...
    sa.Column('type', sa.Enum('chat', 'vision', 'audio', 'image', 'embedding', 'code', 'unknown', name='modeltype'), nullable=False),
    sa.Column('enabled', sa.Boolean(), nullable=False),
    ...
    sa.Column('error_code', sa.Enum('auth', 'rate_limit', 'timeout', 'server', 'network', 'other', name='errorcode'), nullable=True),
    ...
    with op.batch_alter_table('probe_results', schema=None) as batch_op:
        ...
        batch_op.create_index('ix_probe_results_provider_model_time', ['provider_id', 'model_id', 'checked_at'], unique=False)
